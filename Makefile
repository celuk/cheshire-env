...
program_linux:
	...
	python3 tools/uart_send_data_to_dram.py -f /home/shc/projects/cheshire-linux/riscv-opensbi-port/platform/template/custom.dtb.hex -p /dev/ttyUSB1 -sa 0x01200000 -b 921600
	$(MAKE) program ARGS="/home/shc/projects/cva-soc/vivado/cva_soc_zc706/cva_soc_zc706.runs/impl_1/secure_soc.bit"
	python3 tools/uart_send_data_to_dram.py -f /home/shc/projects/cheshire-linux/riscv-linux-4.20/arch/riscv/boot/Image.hex -p /dev/ttyUSB1 -sa 0x00200000 -b 921600
